...
| **open** | T0164-noodle-port-interaction-improvements.md | NoodleController — port dots need active/dragging/drop-ready states + drop target zone is too small (10px `elementFromPoint`, should use proximity snap ~30px). | host | native-ui |
