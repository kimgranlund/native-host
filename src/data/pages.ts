...
const titleOverrides: Record<string, string> = {
  ...
  '/components/kbd': 'Kbd',
  '/packages/n-markdown-editor': 'Markdown Editor',
  '/packages/n-playground': 'Playground',
  '/packages/n-editor': 'Editor',
  ...
  '/showcase/a2ui-training': 'A2UI Training Library',
