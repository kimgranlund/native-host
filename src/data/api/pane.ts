  ...
  sections: [
    {
      ...
      rows: [
        ...
        { name: 'size', type: 'string', default: 'auto', description: 'Initial pane size (e.g. "200px", "25%"). Panes without size share remaining space equally.' },
        ...
        { name: 'scrollable', type: 'boolean', default: 'false', description: 'Makes the pane content area scroll independently when it overflows.' },
      ],
    },
    {
      kind: 'methods',
